...
impl ContextBase {
    ...
    pub async fn select(
        ...
        let tson_data = streamer
            ...
            .await?;
        let df = crate::tercen::tson_to_dataframe(&tson_data)?;
        Ok(df)
    }
    ...
    async fn get_table_column_names(
        ...
        let extract_name = |c: &crate::tercen::client::proto::EColumnSchema| -> Option<String> {
    ...
    pub async fn save_results(
        ...
        crate::tercen::result::save_results(
            Arc::clone(&self.client),
            &self.project_id,
            &self.namespace,
            plots,
